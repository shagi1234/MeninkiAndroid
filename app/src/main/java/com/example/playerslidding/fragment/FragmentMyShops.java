...
public class FragmentMyShops extends Fragment implements OnTabClicked {
    ...
    private void initListeners() {
        b.layBtn.setOnClickListener(view -> addFragment(mainFragmentManager, R.id.fragment_container_main, FragmentNewShop.newInstance()));
        b.layBtn.setOnClickListener(new View.OnClickListener() {
            @Override
